...
function resItemDetail(response = ""){
    if(response != ""){
        ...
        $("#itemForm #hsn_code").val(partyDetail.hsn_code);$("#itemForm #hsn_code").comboSelect();
        $("#itemForm #gst_per").val(parseFloat(partyDetail.gst_per));$("#itemForm #gst_per").comboSelect();
    }else{
        $("#itemForm #item_code").val("");
