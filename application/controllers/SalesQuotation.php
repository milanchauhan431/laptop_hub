...
class SalesQuotation extends MY_Controller{
    ...
    public function create($jsonData){
        ...
        $this->data['partyList'] = $this->party->getPartyList(['party_category' => "1,2,3",'party_type'=>"0,1"]);
        $this->data['itemList'] = $this->item->getItemList(['item_type'=>"1,2,3",'active_item'=>"1,2"]);
