...
class DebitNoteModel extends MasterModel{
    ...
    public function save($data){
        try{
            ...
            if(!empty($data['id'])):  
                $vouData = $this->getDebitNote(['id'=>$data['id'],'itemList'=>0]);
                ...
                $this->remove($this->transDetails,['main_ref_id'=>$data['id'],'table_name'=>$this->transChild,'description'=>"DN BATCH DETAILS"]);
            ...
            foreach($itemData as $row):
                ...
                $batchData['description'] = "DN BATCH DETAILS";
    ...
    public function getDebitNoteItems($data){
        ...
        $queryData['leftJoin']['trans_details'] = "trans_child.trans_main_id = trans_details.main_ref_id AND trans_details.child_ref_id = trans_child.id AND trans_details.description = 'DN BATCH DETAILS' AND trans_details.table_name = '".$this->transChild."'";
    ...
    public function delete($id){
        try{
            ...
            $vouData = $this->getDebitNote(['id'=>$id,'itemList'=>0]);
            if(!empty($vouData->ref_id)):
                $setData = array();
                $setData['tableName'] = $this->transMain;
                $setData['where']['id'] = $vouData->ref_id;
            ...
            $this->remove($this->transDetails,['main_ref_id'=>$id,'table_name'=>$this->transChild,'description'=>"DN BATCH DETAILS"]);
