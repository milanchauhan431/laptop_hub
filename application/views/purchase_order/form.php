                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 form-group">
                                        ...
                                        <input type="date" name="trans_date" id="trans_date" class="form-control fyDates" max="<?=getFyDate(date("Y-m-d"))?>" value="<?=(!empty($dataRow->trans_date))?$dataRow->trans_date:getFyDate()?>">
                                    </div>
