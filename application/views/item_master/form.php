<form>
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-2 form-group <?=(!empty($dataRow->item_type) && $dataRow->item_type != 1 || $item_type != 1)?"hideen":""?>">
            ...
            <div class="<?=(!empty($dataRow->item_type) && $dataRow->item_type != 1 || $item_type != 1)?"col-md-8":"col-md-6"?> form-group">
