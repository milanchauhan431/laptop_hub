                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <ul class="nav nav-pills">
                                    <li class="nav-item"> 
                                        <button onclick="statusTab('leadTable',0);" id="pending_lead" class="nav-tab btn waves-effect waves-light btn-outline-primary active" style="outline:0px" data-toggle="tab" aria-expanded="false">Lead</button> 
                                    </li>
                                    ...
                                    <li class="nav-item"> 
                                        <button onclick="statusTab('leadTable',4);" id="lead_lost" class="nav-tab btn waves-effect waves-light btn-outline-dark" style="outline:0px" data-toggle="tab" aria-expanded="false">Lost</button> 
                                    </li>
                                </ul>
                            </div>
							<div class="col-md-4">
