    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="date" name="inv_date" id="inv_date" class="form-control req fyDates" max="<?=getFyDate()?>" value="<?=(!empty($gateInwardData->inv_date))?$gateInwardData->inv_date:((!empty($gateEntryData->inv_date))?$gateEntryData->inv_date:"")?>" >
            </div>
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="date" name="doc_date" id="doc_date" class="form-control req fyDates" max="<?=getFyDate()?>" value="<?=(!empty($gateInwardData->doc_date))?$gateInwardData->doc_date:((!empty($gateEntryData->doc_date))?$gateEntryData->doc_date:"")?>">
            </div>
